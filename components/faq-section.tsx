...
import { Shield, Clock, DollarSign, Truck } from "@/components/icon-placeholder"
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes, we are fully licensed, insured, and bonded for your complete protection. Our comprehensive coverage includes liability insurance, cargo insurance, and worker's compensation. All certifications are current and available upon request.",
  },
  {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="space-y-8 order-2 lg:order-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              <div className="text-center space-y-3 p-4 min-h-[120px] flex flex-col justify-center">
                <div className="mx-auto w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                  <Shield className="h-6 w-6 text-primary" />
                </div>
                <h3 className="font-bold text-sm md:text-base">Fully Insured</h3>
              ...
              <div className="text-center space-y-3 p-4 min-h-[120px] flex flex-col justify-center">
                ...
                <h3 className="font-bold text-sm md:text-base">On-Time Guarantee</h3>
                <p className="text-xs md:text-sm text-muted-foreground">Reliable scheduling you can count on</p>
              </div>
              <div className="text-center space-y-3 p-4 min-h-[120px] flex flex-col justify-center">
                <div className="mx-auto w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                  <DollarSign className="h-6 w-6 text-primary" />
                </div>
                <h3 className="font-bold text-sm md:text-base">Transparent Pricing</h3>
                <p className="text-xs md:text-sm text-muted-foreground">No hidden fees or surprise charges</p>
              </div>
              <div className="text-center space-y-3 p-4 min-h-[120px] flex flex-col justify-center">
                <div className="mx-auto w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center">
                  <Truck className="h-6 w-6 text-primary" />
                </div>
                <h3 className="font-bold text-sm md:text-base">Professional Team</h3>
                <p className="text-xs md:text-sm text-muted-foreground">Background-checked, trained specialists</p>
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, index) => (
                ...
                >
                  <AccordionTrigger className="text-left font-medium hover:no-underline py-5 md:py-6 text-sm md:text-base min-h-[44px] flex items-center">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground leading-relaxed text-sm md:text-base pb-5 md:pb-6">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
